...
const defaultShortcuts = [
  ...
  { key: "6", icon: <TableOutlined />, label: "Clickup Form" },
  {
    ...
    label: "Add Shortcut",
    iconStyle: { bottom: "10%", position: "absolute" },
  },
];
...
const Homepage = () => {
  ...
  const handleItemClick = (key) => {
    ...
    const paths = {
      ...
      3: "https://ronbowworkspace.slack.com/ssb/redirect?entry_point=workspace_signin",
        ...
        <Layout style={{ padding: "0 5px 24px", backgroundColor: "white" }}>
          ...
          >
            ...
            <Menu mode="horizontal" defaultSelectedKeys={"1"}>
              ...
              <Menu.Item
                key="3"
                icon={<ReadOutlined />}
                onClick={() => setShowContent("resources")}
                style={{ fontWeight: "200", color: "black" }}
              >
          ...
          >
            ...
            <Routes>
              ...
              <Route path="https://ronbowworkspace.slack.com/ssb/redirect?entry_point=workspace_signin"></Route>
